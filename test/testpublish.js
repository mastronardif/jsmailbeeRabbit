...
function makeMsg(msg) {
  ...
  var myMsg  = {
    action: "READ",
    msg: `Work Work!!! ${msg} <tag>http://slashdot.org</tag> `,
    createTime: event.toISOString(),
    sig: "FxM"
  };
  return myMsg;
}
...
function whenConnected() {
  ...
  //publish("", "jobs", new Buffer("xxxxxxxx Queue <tag> work work"));
}
...
setInterval(function() {
  var msg = JSON.stringify(makeMsg("TEST  wok wok") );
  console.log('publish', msg);
  publish("", "jobs", new Buffer(msg));
}, 4000);
